========================================================================
    BIBLIOTECA DE VÍNCULOS DINÁMICOS: VirtualSimulationEnvironment Información general del proyecto
========================================================================

AppWizard ha creado este archivo DLL VirtualSimulationEnvironment.

Este archivo contiene un resumen de lo que encontrará en cada uno de los archivos que constituyen la aplicación VirtualSimulationEnvironment.


VirtualSimulationEnvironment.vcxproj
...
VirtualSimulationEnvironment.vcxproj.filters
...
VirtualSimulationEnvironment.cpp
...
StdAfx.h, StdAfx.cpp
    Estos archivos se usan para compilar un archivo de encabezado precompilado (PCH) denominado VirtualSimulationEnvironment.pch y un archivo de tipos precompilados llamado StdAfx.obj.
