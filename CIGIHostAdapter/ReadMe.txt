========================================================================
    APLICACIÓN DE CONSOLA: CIGIHostAdapter Información general del proyecto
========================================================================

AppWizard ha creado esta aplicación CIGIHostAdapter.

Este archivo contiene un resumen de lo que encontrará en cada uno de los archivos que constituyen la aplicación CIGIHostAdapter.


CIGIHostAdapter.vcxproj
...
CIGIHostAdapter.vcxproj.filters
...
StdAfx.h, StdAfx.cpp
    Estos archivos se usan para compilar un archivo de encabezado precompilado (PCH) denominado CIGIHostAdapter.pch y un archivo de tipos precompilados llamado StdAfx.obj.
