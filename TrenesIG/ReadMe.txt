========================================================================
    APLICACIÓN DE CONSOLA: SimulacionFerroviaria Información general del proyecto
========================================================================

AppWizard ha creado esta aplicación SimulacionFerroviaria.

Este archivo contiene un resumen de lo que encontrará en cada uno de los archivos que constituyen la aplicación SimulacionFerroviaria.


SimulacionFerroviaria.vcxproj
...
SimulacionFerroviaria.vcxproj.filters
...
StdAfx.h, StdAfx.cpp
    Estos archivos se usan para compilar un archivo de encabezado precompilado (PCH) denominado SimulacionFerroviaria.pch y un archivo de tipos precompilados llamado StdAfx.obj.
